...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        DataFrame DataFrameWithSalary = df.withColumn("salary", col(AGE).cast(DataTypes.IntegerType).multiply(size(col(KEYWORDS))).multiply(10));
        ...
        keyWordsExploded = keyWordsExploded
                .filter(col(SALARY).cast(DataTypes.IntegerType).$less(1200))
